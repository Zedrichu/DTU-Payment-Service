Feature: dtupay.E2E DTUPay Payment
    ...
    #Scenario: Unsucessful Payment Not Sufficient Funds
    #  Given a registered customer with DTUPay with balance 0 in the bank
    #  And a registered merchant with DTUPay with balance 800 in the bank
    #  When the merchant initiates a payment of 50 with a token
    #  Then the payment is
